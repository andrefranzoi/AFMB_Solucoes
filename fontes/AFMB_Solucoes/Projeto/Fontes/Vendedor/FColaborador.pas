...
begin
   ...
   Begin
      db_Vendedor.Close;
      db_Vendedor.ParamByName('CODIGO').AsInteger :=
...
procedure TFrmColaborador.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   db_Vendedor.Close;
   Action := Cafree;
end;
...
begin
   db_Vendedor.ParamByName('CODIGO').AsInteger :=
     db_Vendedor.FieldByName('CODIGO').AsInteger;
...
begin
   ...
   db_Vendedor.FieldByName('IDCIDADE').AsInteger :=
