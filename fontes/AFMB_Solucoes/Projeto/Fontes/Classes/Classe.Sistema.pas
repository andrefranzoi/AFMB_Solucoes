...
type
   ...
   public
      ...
      property PastaBinarios: WideString read GetPastaBinarios
        write SetPastaBinarios;
      property ArquivoCFG: String read FArquivoCFG write FArquivoCFG;
      property ExeName: String read GetExeName write SetExeName;
      property PathPrograma: WideString read GetPathPrograma
        write FPathPrograma;
...
begin
   ...
   FArquivoCFG := Concat(_DRIVE, PathDelim, _SISTEMA_NOME, PathDelim,
