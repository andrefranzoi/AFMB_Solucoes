...
uses
  ...
  function ContemNumero(aProcurar: Currency; const aLista: TArray<Currency>): Boolean;
  ...
  procedure GetImagemDLL(aObjeto: TBitmap; aNomeImagem: String; aTipoImagem: TipoImagem = tiBMP);
...
begin
  ...
  case aLocalDados of
    ldPadrao : aQuery.Connection := FrmPrincipal.DBConexao;
...
begin
  ...
  try
    ...
    mQuery.SQL.Add('');
    mQuery.Open;
    mEmailPara  := GetClienteCampo(mQuery.FieldByName('CLIENTE').AsInteger,'email');
...
procedure GetImagemDLL(aObjeto: TBitmap; aNomeImagem: String; aTipoImagem: TipoImagem);
var
 mLibDLL : THandle;
 mPNG    : TPNGObject;
begin
