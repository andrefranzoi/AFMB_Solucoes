...
begin
   ...
   nValorDesconto := GetValorPercentual(db_CtaPagar.FieldByName('VALOR').AsFloat, db_CtaPagar.FieldByName('DESCONTO').AsFloat);
   nValorjuros    := GetValorPercentual(db_CtaPagar.FieldByName('VALOR').AsFloat, db_CtaPagar.FieldByName('DESPESAS_JUROS').AsFloat);
