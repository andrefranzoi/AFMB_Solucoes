      ...
      0:
         Begin
            ...
            Begin
               ...
               db_ComissaoPedidos.ParamByName('CONTACAIXA').AsInteger :=
                 StrToIntDef(EditContaCaixa.text, 0);
            End;
            ...
            Begin
               ...
               db_ComissaoPedidos.ParamByName('CONTACORRENTE').AsInteger :=
                 StrToIntDef(EditContaBancaria.text, 0);
            End;
            ...
            Begin
               ...
               db_ComissaoPedidos.ParamByName('FORMA_PAGTO').AsInteger :=
                 StrToIntDef(EditPagamento.text, 0);
            End;

            if rgpMovimentacao.ItemIndex = 0 then
            Begin
               fsr_ComissaoPedidos.Variables['rptParametro'] :=
                 QuotedStr('Periodo: ' + MskDataIni.text + '  -  ' +
                 MskDataFim.text + ' - (Movimentação: Todos)');
               db_ComissaoPedidos.SQL.add(' AND ');
            ...
            Begin
               fsr_ComissaoPedidos.Variables['rptParametro'] :=
                 QuotedStr('Periodo: ' + MskDataIni.text + '  -  ' +
                 MskDataFim.text + ' - (Movimentação: Créditos)');
               db_ComissaoPedidos.SQL.add(' AND ');
               db_ComissaoPedidos.SQL.add(strCreditoDebito);
            End;
            ...
            Begin
               fsr_ComissaoPedidos.Variables['rptParametro'] :=
                 QuotedStr('Periodo: ' + MskDataIni.text + '  -  ' +
                 MskDataFim.text + ' - (Movimentação: Débitos)');
               db_ComissaoPedidos.SQL.add(' AND ');
               db_ComissaoPedidos.SQL.add(strCreditoDebito);
            End;
            ...
            db_ComissaoPedidos.ParamByName('EMPRESA').AsInteger :=
              FSistema.Empresa;
