...
Type
  ...
  TIBPT = Record
    ...
    procedure Limpar;
    procedure GetIBPT(const aNCM: String; aExTipi: String; const aOrigem: NativeInt);
  end;
...
{ TIBPT }
procedure TIBPT.GetIBPT(const aNCM: String; aExTipi: String; const aOrigem: NativeInt);
Var
  mDataSet : TDataSet;
  mSQL : String;
begin
