...
begin
   ...
   Try
      ...
      SQLConexaoTeste.close;
      AvisoSistema('Falha na conexão com o servidor' + sLineBreak + sLineBreak +
        ' Verificar: ' + sLineBreak + ' - nome ou IP do servidor' + sLineBreak +
        ' - firewall do Windows/Linux (liberar a porta 3050)' + sLineBreak +
        ' - nome do banco de dados' + sLineBreak +
