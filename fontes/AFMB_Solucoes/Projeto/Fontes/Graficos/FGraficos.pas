...
uses
  ...
  FireDAC.Comp.Client, cxGridCustomLayoutView, cxGridCardView, cxGridDBCardView,
...
procedure TFrmDashboardGrafico.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  QryCtaReceber.Close;
  QryCtaPagar.Close;
  Action := Cafree;
