...
begin
   ...
   begin
      db_notasfiscais.Locate('NOTAFISCAL',dbProcurarNFe.ResultFieldAsInteger('NOTAFISCAL'),[]);
   end;
end;
...
begin
  ...
  TFloatField(db_notasfiscais.FieldByName('TRANSPORTADORA_VOLUME')).DisplayFormat := '###,##0';
end;
