...
begin
   ...
   case rRestricao.ItemIndex of
      ...
      0: strRestricaoCredito := '';
      1: strRestricaoCredito := 'S';
      2: strRestricaoCredito := 'N';

   End;


   case RadioG.ItemIndex of
      0: FrmRelReceb_Extrato := TFrmRelReceb_Extrato.create(self);
      1: FrmRelReceb_Receber := TFrmRelReceb_Receber.create(self);
      2: FrmRelReceb_Vencidas := TFrmRelReceb_Vencidas.create(self);
      3: FrmRelReceb_Quitadas := TFrmRelReceb_Quitadas.create(self);
      4: FrmRelReceb_QuitadasDataPagto := TFrmRelReceb_QuitadasDataPagto.create(self);
      5: FrmRelReceb_Historico := TFrmRelReceb_Historico.create(self);
   end;
