object FrmCtaReceberBaixasLotesCheques: TFrmCtaReceberBaixasLotesCheques
  ...
  object db_CtaReceberCheque: TFDQuery
    ...
    object db_CtaReceberChequeVALOR: TFloatField
      FieldName = 'VALOR'
      DisplayFormat = '###,##0.00'
    end
    object db_CtaReceberChequeVALOR_PAGO: TFloatField
      FieldName = 'VALOR_PAGO'
    end
    object db_CtaReceberChequeVALOR_SALDO: TFloatField
    ...
    object db_CtaReceberChequeDESCONTO: TFloatField
      FieldName = 'DESCONTO'
    end
    ...
    object db_CtaReceberChequeENTRADA: TFloatField
      FieldName = 'ENTRADA'
    end
    ...
    object db_CtaReceberChequeDESPESAS_BOLETO: TFloatField
      FieldName = 'DESPESAS_BOLETO'
    end
    object db_CtaReceberChequeDESPESAS_JUROS: TFloatField
      FieldName = 'DESPESAS_JUROS'
    end
    object db_CtaReceberChequeDESPESAS_MULTA: TFloatField
      FieldName = 'DESPESAS_MULTA'
    end
    object db_CtaReceberChequeDESPESAS_CARTORIO: TFloatField
      FieldName = 'DESPESAS_CARTORIO'
    end
    object db_CtaReceberChequeDESPESAS_TOTAL: TFloatField
