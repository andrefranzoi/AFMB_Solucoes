...
begin
   ...
   db_CtaReceberChequeSomar.ParamByName('CLIENTE').AsInteger          := StrToIntDef(Trim(FrmCtaReceberBaixasLotes.EditCliente.Text),0);
...
begin
   ...
   db_CtaReceberCheque.FieldByName('CLIENTE').AsInteger            := StrToIntDef(Trim(FrmCtaReceberBaixasLotes.EditCliente.Text),0);
...
begin
   ...
   db_CtaReceberCheque.ParamByName('CLIENTE').AsInteger          := StrToIntDef(Trim(FrmCtaReceberBaixasLotes.EditCliente.Text),0);
