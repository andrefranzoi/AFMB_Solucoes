...
uses
   ...
   Vcl.Controls, Vcl.Forms, Vcl.Dialogs, FEmailTemplate, Vcl.StdCtrls,
   Vcl.ExtCtrls, Vcl.Buttons, dxGDIPlusClasses;
...
begin
   ...
   try
      ...
      on E: Exception do
      begin
         AvisoSistemaErro('E-MAIL NÃO ENVIADO!!' + sLineBreak + sLineBreak +
           E.Message);
         ErroEnvio := True;
      end;
   end;
...
begin
   ...
   lbledtPara.Text := BaseDados.db_Parametros.FieldByName
     ('CONTAB_EMAIL').AsString;

   // Nome Fantasia da Empresa
   lbledtAssunto.Text := 'Notas Fiscais ' + BaseDados.db_Parametros.FieldByName
