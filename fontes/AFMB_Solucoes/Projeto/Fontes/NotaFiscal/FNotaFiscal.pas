...
begin
   ...
   if not FProgramador then
      ...
      Begin
         AvisoSistemaErro('Venda já foi faturada. Não é permitido excluir.' +
           sLineBreak + sLineBreak + 'Você poderá somente cancelar a NF-e.');
         Exit;
      End;
   ...
   if not FProgramador then
      ...
      begin
         AvisoSistema
           ('Esta Nota Fiscal Eletrônica já foi enviada para a SEFAZ. ' +
...
begin
   ...
   begin
      AvisoSistema
        ('Você cancelou a operação. Para processeguir é necessário finalizar a nota fiscal.');
      Abort;
   end;
