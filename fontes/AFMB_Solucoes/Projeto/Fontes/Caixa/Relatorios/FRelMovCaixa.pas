...
begin
   ...
   Begin
      FrmRelMovCaixaSaldoDiarioAnalitico :=
        TFrmRelMovCaixaSaldoDiarioAnalitico.create(self);
   End;

   If RadioG.ItemIndex = 2 then
   Begin
      dbFechamentoCaixa.close;
      dbFechamentoCaixa.ParamByName('DATA_INI').AsDate :=
        StrToDate(FrameDatas1.MskDataIni.text);
      dbFechamentoCaixa.ParamByName('DATA_FIM').AsDate :=
        StrToDate(FrameDatas1.MskDataFim.text);
